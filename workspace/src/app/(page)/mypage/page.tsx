...
const Page = () => {
  ...
  const CardData = [
    {
      musicUrl:
        'https://open.spotify.com/embed/track/54ezuGQj5s0ot4J7ktWb2h?utm_source=generator&theme=0',
      commentTitle: 'ずっと好き',
    },
    {
      musicUrl:
        'https://open.spotify.com/embed/track/12usPU2WnqgCHAW1EK2dfd?utm_source=generator&theme=0',
      commentTitle: '青春！',
    },
    {
      musicUrl:
        'https://open.spotify.com/embed/track/0nUKU6e9COOCgO5tAUtlST?utm_source=generator&theme=0',
      commentTitle: 'かっこいい',
    },
    {
      musicUrl:
        'https://open.spotify.com/embed/track/7ovUcF5uHTBRzUpB6ZOmvt?utm_source=generator&theme=0',
      commentTitle: '気分が上がる！',
    },
  ];
  ...
  return (
    <div className="outer-container min-h-screen bg-white flex flex-col">
      ...
      <div className="flex flex-col items-center px-5 safari-hack flex-1">
        <div className="max-w-screen-lg w-full p-8">
          <h2 className="text-left mb-4 text-xl text-black font-bold">
            最近の投稿
          </h2>
          ...
          <h2 className="text-left text-xl text-black font-bold mb-8">
            お気に入りの曲
          </h2>
          ...
          <div className="flex flex-col items-center">
            ...
            <a href="./login" style={{ color: "red", marginBottom: "100px" }}>
              ログアウト
            </a>
          </div>
